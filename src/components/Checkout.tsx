...
export function Checkout({
  ...
  const paymentAmount = convertFromUSD(totalUSD, currency);
      ...
      if (!response.ok || !data.checkout_url) {
        throw new Error(
          typeof data.error === "string"
            ? data.error
            : data.error?.message || "Unable to start PayFlow checkout."
        );
      }

      // PayFlow hosts the secure payment page. No Cashfree SDK or secret
      // credentials are exposed in the browser.
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 lg:sticky lg:top-24">
              ...
              <div className="mt-5 space-y-2.5 text-sm">
                ...
                <div className="text-[11px] text-slate-400 pt-1">
                  Base quote covers 2 adults. Additional adults are charged at {formatPrice(pricing.extraAdultUSD, currency)} each. 5% margin included.
                </div>
              </div>
