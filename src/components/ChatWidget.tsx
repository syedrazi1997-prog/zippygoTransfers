...
export function ChatWidget({ onManageBooking }: ChatWidgetProps) {
  ...
  const botResponses: Record<string, string> = {
    "How do I book a transfer?":
      "Booking is easy! Select the 'Airport Transfers' tab, enter your pickup airport and destination hotel, choose a date and time, then pick a vehicle. You'll pay securely via PayFlow and receive an instant confirmation.",
    "What vehicles are available?":
