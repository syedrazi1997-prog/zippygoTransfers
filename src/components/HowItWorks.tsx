...
export function HowItWorks() {
  const steps = [
    ...
    },
    {
      icon: CreditCard,
      title: "Pay Securely",
      description: "Checkout in minutes with PayFlow. Pay in your local currency with free cancellation up to 24h.",
    },
    {
      icon: Car,
  ...
  const features = [
    ...
    { icon: ShieldCheck, title: "Secure Payments", description: "Bank-grade encryption with PayFlow" },
