...
import { AirportTransfersIndexPage, SeoAirportPage } from "./components/SeoAirportPage";
import { getAirportSeoFromPath } from "./lib/seo";
...
export default function App() {
  ...
  const seoAirport = getAirportSeoFromPath();
  const isAirportTransfersIndex = window.location.pathname === "/airport-transfers" || window.location.pathname === "/airport-transfers/";
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans antialiased text-slate-900">
      ...
      <main className="flex-grow">
        {seoAirport && <SeoAirportPage airport={seoAirport} />}
        {!seoAirport && isAirportTransfersIndex && <AirportTransfersIndexPage />}

        {!seoAirport && !isAirportTransfersIndex && view === "home" && (
          <>
