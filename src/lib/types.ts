...
export type TransferMode = "private" | "shuttle";
...
export interface Vehicle {
  ...
  priceUSD?: number;
  /** If set, this vehicle is only offered for the specified transfer mode. */
  transferMode?: TransferMode;
  /** If true, the option is only shown for airport transfers. */
